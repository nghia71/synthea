...
./run_synthea -p 23 Alberta
./run_synthea -p 27 "British Columbia"
./run_synthea -p 7 Manitoba
./run_synthea -p 4 "New Brunswick"
./run_synthea -p 3 "Newfoundland and Labrador"
./run_synthea -p 1 "Northwest Territories"
./run_synthea -p 5 "Nova Scotia"
./run_synthea -p 1 Nunavut
./run_synthea -p 77 Ontario
./run_synthea -p 1 "Prince Edward Island"
./run_synthea -p 45 Quebec
./run_synthea -p 6 Saskatchewan
./run_synthea -p 1 Yukon